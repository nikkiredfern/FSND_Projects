...
class Venue(db.Model):
    ...
    shows = db.relationship('Shows', backref='venue_table', lazy=True)
...
class Artist(db.Model):
    ...
    shows = db.relationship('Shows', backref='artist_table', lazy=True)
